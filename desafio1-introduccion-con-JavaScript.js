...
/*Utiliza un prompt para preguntar el nombre del usuario 
y almacénalo en la variable nombre .*/
let nNombre = prompt('¿Cual es tu nombre?');
//Pide al usuario que ingrese su edad usando un prompt y almacénala en la variable edad.
let nEdad = prompt('Ingresa tu edad:');
/*Ahora, si la edad es mayor o igual a 18, 
